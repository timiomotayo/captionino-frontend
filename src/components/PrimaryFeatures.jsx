  ...
  const features = [
    {
      ...
      image:
        theme === "dark" ? screenshotSelectImageDark : screenshotSelectImage,
    },
    {
      title: "Choose type",
      description:
    ...
    },
    {
      ...
      image:
        theme === "dark" ? screenshotCopyCaptionDark : screenshotCopyCaption,
    },
    {
      ...
      image:
        theme === "dark"
          ? screenshotRecentActivityDark
          : screenshotRecentActivity,
    },
  ];
              ...
              <TabPanels className="lg:col-span-7">
                {features.map((feature) => (
                  <TabPanel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-130 h-70 overflow-hidden rounded-xl bg-background shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-250 sm:h-auto lg:h-150">
                      <Image

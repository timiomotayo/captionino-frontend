        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:gap-12 mt-12">
            <div className="flex flex-col justify-between space-y-4 rounded-lg border border-gray-200 dark:border-gray-900 p-6 shadow-sm bg-white dark:bg-background">
              <div className="space-y-2">
                <p className="text-gray-800 dark:text-gray-400">
                  "Captionino has saved me so much time creating content for my social media. The captions are creative
                  and engaging!"
                </p>
              </div>
              <div className="flex items-center space-x-4">
                <img src="/default-avatar.jpg" className="rounded-full bg-gray-200 h-10 w-10"></img>
                <div>
            ...
            <div className="flex flex-col justify-between space-y-4 rounded-lg border border-gray-200 dark:border-gray-900 p-6 shadow-sm bg-white dark:bg-background">
              <div className="space-y-2">
                <p className="text-gray-800 dark:text-gray-400">
                  "As an e-commerce store owner, the product descriptions generated by Captionino have helped increase
